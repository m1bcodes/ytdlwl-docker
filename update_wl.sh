...
yt-dlp --embed-thumbnail --embed-metadata --embed-chapters --restrict-filenames -f "best[height=720]" --cookies ./cookies/cookies.txt --paths $OUTPUT_PATH https://www.youtube.com/playlist?list=WL 
